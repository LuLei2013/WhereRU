...
public class MessageFragmentAdapter extends BaseAdapter {
    ...
    public MessageFragmentAdapter(Context context, SwipeListView swipeListView, List<MessageFragment.MessageItem> messageItemList) {
        this.mContext = context;
        this.mListView = swipeListView;
        this.mMessageItemList = messageItemList;
        this.mInInflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    }
